...
class ProjectForm(forms.ModelForm):
    class Meta:
        ...
        labels = {
            ...
            'price_hour_developer': 'Precio Hora Desarrollador',
            'resources' : 'Recursos',
        ...
        widgets = {
            ...
            'hours_estimated': forms.NumberInput(attrs={'class': 'from-control', 'style': 'width:35%', }),
            'price_hour_developer': forms.NumberInput(attrs={'class': 'from-control', 'style': 'width:35%', }),
