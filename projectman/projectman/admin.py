...
from projectman.models import Log
...
class ProjectAdmin(admin.ModelAdmin):
    ...
    list_display = ('title', 'project_manager', 'description', 'methodology','state', 'resources',
    ...
    fieldsets = [
        (None, {'fields': ['title']}),
        ('Project information', {'fields': ['project_manager', 'description', 'methodology','state', 'resources', 'budget']}),
...
class TaskAdmin(admin.ModelAdmin, GrappelliSortableHiddenMixin):
    parent_model = Task
    form = TaskCreationForm
    list_display = ('name', 'project', 'description', 'requeriments', 'costs','real_time',
...
class Log(admin.ModelAdmin):
    list_display = ('task', 'developer_profile', 'time_log', 'date')