# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-06-26 22:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('methodology', models.CharField(default='sin', max_length=50)),
            ...
            options={
                'permissions': (('view_project', 'Can see projects'),),
                'ordering': ['position'],
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('position', models.PositiveSmallIntegerField(default=0, verbose_name='Position')),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='projectman.Project')),
            ...
            options={
                'permissions': (('view_task', 'Can see task'), ('change_status_task', 'Can change status to task')),
                'ordering': ['position'],
            },
        ),
        migrations.AddField(
